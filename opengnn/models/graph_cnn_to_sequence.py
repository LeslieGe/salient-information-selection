...
class GraphConvToSequence(Model):
    def __init__(self,
    ...
    def __call__(self,
        ...
        with tf.variable_scope("encoder"):
            representations, initial_state, conv_features = self.encoder(
        ...
        if labels is not None:
            ...
            with tf.variable_scope("decoder") as scope:
                ...
                _, logits, decoder_loss = self.decoder.decode(
                    ...
                    extend_memory=conv_features,
                    extend_memory_sequence=primary_paths,
                    extend_memory_length=primary_path_lengths,
                    mode=mode)
